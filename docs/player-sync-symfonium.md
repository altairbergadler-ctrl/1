...
Статус: runbook подготовлен, но на production и реальном телефоне ещё не
выполнялся. Покупка/установка приложения, production migration и создание
реального player credential требуют отдельного подтверждения.
